...
const ManageUsers = () => {
    ...
    const getAllUserData = () => {
        const url = "https://slimnewsitebackend.onrender.com/api/alluserdata";
        axios
            .get(url)
            .then((response) => {
...
// };
    ...
    const adminAproveEmailSand = async (email) => {
        ...
        fetch('https://slimnewsitebackend.onrender.com/api/adminAproveEmailSand', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    const Verify = (id) => { 
            const url = `https://slimnewsitebackend.onrender.com/api/UserVerify/${id}`;
            axios.patch(url)
                .then((response) => {
    ...
    return (
        <>
            <div className="w-full h-max px-6 py-10 flex flex-col gap-2 phone:gap-8 bg-[#f9fbfd] text-[rgb(87,89,98)]">
                <p className="text-[27px] font-semibold">Trade Bitpay users list</p>
